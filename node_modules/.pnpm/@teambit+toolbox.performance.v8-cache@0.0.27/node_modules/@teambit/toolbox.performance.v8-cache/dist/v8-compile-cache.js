...
exports.nativeCompileCache = exports.NativeCompileCache = void 0;
// Copied from https://github.com/zertosh/v8-compile-cache and modified to be disabled on demand
const file_system_blob_store_1 = require("./file-system-blob-store");
    ...
    _moduleCompile(filename, content) {
        ...
        const script = new vm.Script(wrapper, {
            ...
            importModuleDynamically() {
                throw new Error('[v8-compile-cache] Dynamic imports are currently not supported. See https://github.com/zertosh/v8-compile-cache/issues/30 for more information. You should call `NativeCompileCache.uninstall()` before using dynamic imports.');
            },
        });
...
exports.NativeCompileCache = NativeCompileCache;
...
exports.nativeCompileCache = null;
if (!process.env.DISABLE_V8_COMPILE_CACHE && supportsCachedData()) {
    const cacheDir = getCacheDir();
    const prefix = getParentName();
    const blobStore = new file_system_blob_store_1.FileSystemBlobStore(cacheDir, prefix);
    exports.nativeCompileCache = new NativeCompileCache(blobStore);
    process.once('exit', () => {
...
//# sourceMappingURL=v8-compile-cache.js.map