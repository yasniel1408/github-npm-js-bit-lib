...
module.exports = {
    ...
    overrides: [
        ...
        Object.assign(Object.assign({ files: ['*.md', '*.mdx'], extends: ['plugin:mdx/recommended', 'plugin:react/recommended'] }, configs.overrides), { rules: Object.assign(Object.assign({}, configs.overrides.rules), { 'react/jsx-uses-vars': 'error', 'react/jsx-uses-react': 'error' }), 
            // parser: 'eslint-mdx',
            parserOptions: {
