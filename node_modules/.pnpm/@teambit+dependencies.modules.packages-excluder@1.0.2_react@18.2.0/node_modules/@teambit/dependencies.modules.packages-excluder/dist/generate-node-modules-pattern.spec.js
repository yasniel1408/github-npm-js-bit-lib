...
describe('generateNodeModulesPattern()', () => {
    describe('default format for JEST', () => {
        ...
        describe('should work with packages under the .pnpm directory', () => {
            ...
            let regex;
            beforeAll(() => {
                pattern = (0, generate_node_modules_pattern_1.generateNodeModulesPattern)({ packages: ['@shohamgilad'], excludeComponents: false });
                regex = new RegExp(pattern);
            });
    ...
    describe('format for webpack', () => {
        ...
        describe('when packages contains a single package', () => {
            let patterns;
            beforeAll(() => {
                patterns = (0, generate_node_modules_pattern_1.generateNodeModulesPattern)({
        ...
        describe('when packages are provided', () => {
            ...
            it('should exclude the packages from absolute paths', () => {
                ...
                expect(regexps.every((regexp) => regexp.test('/Users/aUser/dev/bit-example/node_modules/.pnpm/@my-org+my-scope.components/package.json'))).toBeFalsy();
            });
            it('should not exclude other packages', () => {
                expect(regexps.some((regexp) => regexp.test('/Users/aUser/dev/bit-example/node_modules/@my-org/my-scope.apps/package.json'))).toBeTruthy();
                expect(regexps.some((regexp) => regexp.test('/Users/aUser/dev/bit-example/node_modules/@lodash/package.json'))).toBeTruthy();
                expect(regexps.some((regexp) => regexp.test('/Users/aUser/dev/bit-example/node_modules/@react/package.json'))).toBeTruthy();
            });
        });
    });
});
